...
public class Main {
    ...
    public void Geocode() throws IOException {
        try {
            geocode geocode0 = new geocode();
            System.out.println("请输入地址（输入0可返回主菜单）");
            geocode0.Do_geocode();
    ...
    public void Direction() throws IOException {
        try {
            ...
            integrated integrated0 = new integrated();
            driving driving0 = new driving();
            bicycling bicycling0 = new bicycling();

            System.out.println("请输入出发点（输入0可返回主菜单）");
            geocode1.Do_geocode();
            ...
            System.out.println("请输入目的地（输入0可返回主菜单）");
            geocode2.Do_geocode();
    ...
    public void Text() throws IOException {
        try {
            ...
            System.out.print("请输入查询关键词（如：美食、学校）（输入0可返回主菜单）\n");
...
//        this.types=scanner.nextLine();
            System.out.print("请输入查询城市（仅限城市名，如：东莞、广州）（输入0可返回主菜单）\n");
    ...
    public void Around() throws IOException {
        try {
            around around0 = new around();
            geocode geocode0 = new geocode();
            System.out.println("请输入地点（输入0可返回主菜单）");
            if (geocode0.return0==1){
                System.out.println("\n返回主菜单\n");
                return;
            }
    ...
    public void Ip() throws IOException {
        try {
            ip ip0 = new ip();
            System.out.println("请输入需要搜索的IP地址（仅支持国内）（输入0可返回主菜单）");
            Scanner scanner = new Scanner(System.in);
    ...
    public void WeatherInfo() throws IOException {
        try {
            geocode geocode0 = new geocode();
            weatherInfo weatherInfo0 = new weatherInfo();
            ...
            System.out.println("\n" + geocode0.formatted_address +
                    "未来三日的天气：");

//            System.out.println("日期：\t\t\t\t\t" + weatherInfo0.date01 + "\t\t" + weatherInfo0.date02 + "\t\t" + weatherInfo0.date03);
//            System.out.println("星期：\t\t\t\t\t" + weatherInfo0.week01 + "\t\t" +
//                    "\t" +
//                    "\t" + weatherInfo0.week02 + "\t\t\t\t" + weatherInfo0.week03);
//            System.out.println("白天天气现象：\t\t\t" + weatherInfo0.dayweather01 +
//                    "\t" +
//                    "\t\t" +
//                    "\t" + weatherInfo0.dayweather02 + "\t\t\t\t" + weatherInfo0.dayweather03);
//            System.out.println("晚上天气现象：\t\t\t" + weatherInfo0.nightweather01 +
//                    "\t\t" +
//                    "\t\t" + weatherInfo0.nightweather02 + "\t\t\t\t" + weatherInfo0.nightweather03);
//            System.out.println("白天温度（摄氏度）：\t\t" + weatherInfo0.daytemp01 +
//                    "\t\t" +
//                    "\t\t" + weatherInfo0.daytemp02 + "\t\t\t\t" + weatherInfo0.daytemp03);
//            System.out.println("晚上温度（摄氏度）：\t\t" + weatherInfo0.nighttemp01 +
//                    "\t" +
//                    "\t\t" +
//                    "\t" + weatherInfo0.nighttemp02 + "\t\t\t\t" + weatherInfo0.nighttemp03);
//            System.out.println("白天风向：\t\t\t\t" + weatherInfo0.daywind01 + "\t" +
//                    "\t\t" +
//                    "\t" + weatherInfo0.daywind02 + "\t\t\t\t" + weatherInfo0.daywind03);
//            System.out.println("晚上风向：\t\t\t\t" + weatherInfo0.nightwind01 +
//                    "\t\t" +
//                    "\t\t" + weatherInfo0.nightwind02 + "\t\t\t\t" + weatherInfo0.nightwind03);
//            System.out.println("白天风力（级）：\t\t\t" + weatherInfo0.daypower01 +
//                    "\t\t" +
//                    "\t\t" + weatherInfo0.daypower02 + "\t\t\t\t" + weatherInfo0.daypower03);
//            System.out.println("晚上风力（级）：\t\t\t" + weatherInfo0.nightpower01 + "\t" +
//                    "\t\t" +
//                    "\t" + weatherInfo0.nightpower02 + "\t\t\t\t" + weatherInfo0.nightpower03 + "\n");
